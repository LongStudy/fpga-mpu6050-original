...
//VERSION_BEGIN 11.0SP1 cbx_altbarrel_shift 2011:07:03:21:05:55:SJ cbx_altfp_convert 2011:07:03:21:05:55:SJ cbx_altpriority_encoder 2011:07:03:21:05:55:SJ cbx_altsyncram 2011:07:03:21:05:55:SJ cbx_cycloneii 2011:07:03:21:05:55:SJ cbx_lpm_abs 2011:07:03:21:05:55:SJ cbx_lpm_add_sub 2011:07:03:21:05:55:SJ cbx_lpm_compare 2011:07:03:21:05:55:SJ cbx_lpm_decode 2011:07:03:21:05:55:SJ cbx_lpm_divide 2011:07:03:21:05:55:SJ cbx_lpm_mux 2011:07:03:21:05:55:SJ cbx_mgl 2011:07:03:21:07:56:SJ cbx_stratix 2011:07:03:21:05:55:SJ cbx_stratixii 2011:07:03:21:05:55:SJ cbx_stratixiii 2011:07:03:21:05:55:SJ cbx_stratixv 2011:07:03:21:05:55:SJ cbx_util_mgl 2011:07:03:21:05:55:SJ  VERSION_END
...
module  i16to32f_altbarrel_shift_uvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //i16to32f_altbarrel_shift_uvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //i16to32f_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //i16to32f_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	i16to32f_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	i16to32f_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //i16to32f_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	i16to32f_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	i16to32f_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //i16to32f_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	i16to32f_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	i16to32f_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //i16to32f_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	i16to32f_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	i16to32f_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //i16to32f_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	i16to32f_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	i16to32f_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //i16to32f_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 155 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  i16to32f_altfp_convert_p1n
	( 
	clock,
	dataa,
	result) ;
	...
	i16to32f_altbarrel_shift_uvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	i16to32f_altpriority_encoder_rb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //i16to32f_altfp_convert_p1n
//VALID FILE
...
module i16to32f (
	...
	i16to32f_altfp_convert_p1n	i16to32f_altfp_convert_p1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL i16to32f.cmp FALSE TRUE
